...
//! A collection of micro-benchmarks for revons os. 
//! They include null syscall, context switching, process creation, memory mapping, IPC and file system benchmarks.
//! 
//! To run the memory mapping benchmark, revons os should be compiled with the "bm_map" configuration option.
//! To run the IPC benchmarks, revons os should be compiled with the "bm_ipc" configuration option.
