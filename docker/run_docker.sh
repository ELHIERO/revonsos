...
DOCKER_TAG="revonsos:Dockerfile"

# DOCKER_DIR is the directory containing this docker script and the Dockerfile
DOCKER_DIR=$(dirname $(readlink -f ${BASH_SOURCE}))
### REVONSOS_BASE_DIR is the base directory of the RevonsOs repository.
REVONSOS_BASE_DIR=$(readlink -f ${DOCKER_DIR}/.. )
...
# Rather than copy files, we just mount the host machine's RevonsOs directory within the docker container. 
