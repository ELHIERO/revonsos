...
TARGET ?= $(ARCH)-revonsos

## The top level directory of the RevonsOs project
...
## but isn't necessary because RevonsOs supports parsing DWARF .debug_* sections to handle stack unwinding.
