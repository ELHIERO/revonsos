...
//! A libc implementation that is targeted for and runs atop revonsos. 
...
/// The entry point that RevonsOs's task spawning logic will invoke (from its task wrapper).
/// 
